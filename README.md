...
https://github.com/thecrood/portfolio
...
- Click [here](https://rohit-portfolio.netlify.app/) to view the live demo.
...
- [Download the ZIP file from this location](https://github.com/thecrood/portfolio/archive/refs/heads/main.zip) or run the following [git](https://git-scm.com/) command to clone the files to your machine:

```
git clone https://github.com/thecrood/portfolio.git
```
...
- GitHub: [@thecrood](https://github.com/thecrood)
- LinkedIn: [Rohit Chaudhary](https://www.linkedin.com/in/rohit-chaudhary-038171158/)
